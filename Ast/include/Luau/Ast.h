...
namespace Luau {
    ...
    struct AstLocal {
        ...
        AstLocal(const AstName &name, const Location &location, AstLocal *shadow, size_t functionDepth,
                 size_t loopDepth, AstType *annotation)
                : name(name), location(location), shadow(shadow), functionDepth(functionDepth), loopDepth(loopDepth),
...
#define LUAU_RTTI(Class) \
    ...
    public:
        ...
        AstExprFunction(const Location &location, const AstArray<AstGenericType> &generics,
                        ...
                        AstTypePack *varargAnnotation = nullptr, bool hasEnd = false,
    ...
    public:
        ...
        AstExprIfElse(const Location &location, AstExpr *condition, bool hasThen, AstExpr *trueExpr, bool hasElse,
                      AstExpr *falseExpr);
    ...
    public:
        ...
        AstStatIf(const Location &location, AstExpr *condition, AstStatBlock *thenbody, AstStat *elsebody,
    ...
    public:
        ...
        AstStatWhile(const Location &location, AstExpr *condition, AstStatBlock *body, bool hasDo,
    ...
    public:
        ...
        AstStatFor(const Location &location, AstLocal *var, AstExpr *from, AstExpr *to, AstExpr *step,
    ...
    public:
        ...
        AstStatForIn(const Location &location, const AstArray<AstLocal *> &vars, const AstArray<AstExpr *> &values,
    ...
    public:
        ...
        AstStatDeclareClass(const Location &location, const AstName &name, std::optional<AstName> superName,
...
// Don't have Luau::Variant available, it's a bit of an overhead, but a plain struct is nice to use
    ...
    public:
        ...
        AstTypeReference(const Location &location, std::optional<AstName> prefix, AstName name,
    ...
    public:
        ...
        AstTypeFunction(const Location &location, const AstArray<AstGenericType> &generics,
                        const AstArray<AstGenericTypePack> &genericPacks,
                        const AstTypeList &argTypes, const AstArray<std::optional<AstArgumentName>> &argNames,
