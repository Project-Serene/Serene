    ...
    switch (lua_gettop(L)) { /* check number of arguments */
        ...
        case 2: { /* lower and upper limits */
            ...
            luaL_argcheck(L, ul < UINT_MAX, 2,
                          "interval is too large"); // -INT_MIN..INT_MAX interval can result in integer overflow
...
static const unsigned char kPerlin[512] = {151, 160, 137, 91, 90, 15, 131, 13, 201, 95, 96, 53, 194, 233, 7, 225, 140,
                                           36, 103, 30, 69, 142, 8, 99,
