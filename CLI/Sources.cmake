...
target_sources(Luau.VM PRIVATE
        ...
        src/VM/lapi.cpp
        src/VM/laux.cpp
        src/VM/Libraries/lbaselib.cpp
        src/VM/Libraries/lbitlib.cpp
        src/VM/Libraries/lbuiltins.cpp
        src/VM/lcorolib.cpp
        src/VM/ldblib.cpp
        src/VM/ldebug.cpp
        src/VM/ldo.cpp
        ...
        src/VM/lgc.cpp
        src/VM/lgcdebug.cpp
        src/VM/Libraries/linit.cpp
        src/VM/Libraries/lmathlib.cpp
        src/VM/lmem.cpp
        src/VM/lnumprint.cpp
        src/VM/lobject.cpp
        src/VM/Libraries/loslib.cpp
        src/VM/lperf.cpp
        src/VM/lstate.cpp
        src/VM/lstring.cpp
        src/VM/lstrlib.cpp
        ...
        src/VM/ludata.cpp
        src/VM/lutf8lib.cpp
        src/VM/lvmexecute.cpp
        src/VM/lvmload.cpp
        src/VM/lvmutils.cpp
        src/VM/lapi.h
        src/VM/Libraries/lbuiltins.h
        src/VM/lbytecode.h
        src/VM/lcommon.h
        src/VM/ldebug.h
        src/VM/ldo.h
...
# Target Sources for Serene
target_sources(Serene.ToolChain PRIVATE
        Common/Luau/
        Common/
        ...
        SereneToolChain/FileUtils.h
        SereneToolChain/FileUtils.cpp

        SereneToolChain/Flags.h
        SereneToolChain/Flags.cpp

        SereneToolChain/main.cpp
        )

if (TARGET Serene.ToolChain.CLI)
    target_sources(Serene.ToolChain.CLI PRIVATE
